...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div className="flex justify-between mt-auto items-center">
            ...
            <Link href={project.githubLink} target="_blank" className="text-gray-500 hover:text-white transition text-sm">
              GitHub
            </Link>
          </div>
        </div>
      ...
      {/* Gallery Modal */}
      {galleryOpen && project.gallery && project.gallery.length > 0 && (
        <GalleryModal items={project.gallery} onClose={() => setGalleryOpen(false)} />
      )}
    </>
  );
};
